...
\usepackage[english]{babel} % nederlandse tekstopmaak % english
...
%\usepackage[latin1]{inputenc} % zorgt dat je ook é ë en dergelijke kan ingeven
%\usepackage[utf8]{inputenc} % zorgt dat je ook é ë en dergelijke kan ingeven
...
% \usepackage{icomma}   % zet de spatiëring goed bij kommagetallen (Europeese notatie)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{subfiles}
%figuren plaatsen in het document
\usepackage{sidecap}
\usepackage{wrapfig}
\usepackage{hyperref}
\usepackage{cite}
