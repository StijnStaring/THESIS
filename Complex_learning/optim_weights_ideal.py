...
def optim_weights_ideal(theta_d,data_cl,iteration,N,plotting,axcom1a,axcom1b,axcom2,axcom3a,axcom3b,axcom4a,axcom4b,axcom5a,axcom5b,axcom6a,axcom6b,axcom7a,axcom7b,axcom8a,axcom8b,axcom9a,axcom9b,axcom10,axcom11a,axcom11b,file):
    ...
    print("")
    print('Integrated calculated feature values: ')
    print('-----------------------------------------')
    ...
    if iteration == 1:
        ...
        axcom3a.plot(time_vector, vx_sol, '.-',  linewidth=3.0,label="init "+file[15:-4])
        axcom3b.plot(time_vector, vy_sol, '.-',  linewidth=3.0,label="init "+file[15:-4])
        axcom4a.plot(time_vector, ax_tot_sol, '.-',  linewidth=3.0,label="init "+file[15:-4])
        axcom4b.plot(time_vector, ay_tot_sol, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom5a.plot(time_vector, jx_tot_sol, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom5b.plot(time_vector, jy_tot_sol, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom6a.plot(time_vector, psi_sol*180/plt.pi, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom6b.plot(time_vector, psi_dot_sol*180/plt.pi, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom7a.plot(time_vector, throttle_sol, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom7b.plot(time_vector, delta_sol*180/plt.pi, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom8a.plot(time_vector, atx_sol, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom8b.plot(time_vector, anx_sol, '.-', linewidth=3.0,label="init "+file[15:-4])
        axcom9a.plot(time_vector, aty_sol, '.-', linewidth=3.0, label="init " + file[15:-4])
        axcom9b.plot(time_vector, any_sol, '.-', linewidth=3.0, label="init " + file[15:-4])
        axcom10.plot(time_vector, psi_ddot_sol*180/plt.pi, '.-', linewidth=3.0, label="init "+file[15:-4])
        axcom11a.plot(time_vector[0:N], throttle_dot_sol, '.-', linewidth=3.0, label="init " + file[15:-4])
        axcom11b.plot(time_vector[0:N], delta_dot_sol * 180 / plt.pi, '.-', linewidth=3.0, label="init " + file[15:-4])
        ...
        plan_path.save('tracking_lane_change.casadi')
