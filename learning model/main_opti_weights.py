...
[f1_o,f2_o,f3_o,f4_o,f5_o,init_matrix,des_matrix,dict_list,files] = import_data(plot_datasets)

# plotting
[axf,acw, axfn, axcom1a,axcom1b,axcom2,axcom3a,axcom3b,axcom4a,axcom4b,axcom5a,axcom5b,axcom6,axcom7a,axcom7b,axcom8a,axcom8b] = comparing_features(dict_list)
axf.plot([f1_o/f1_o,f2_o/f2_o,f3_o/f3_o,f4_o/f4_o,f5_o/f5_o],'-', marker='*', markersize=6, label = "Observed features")
...
while rec < 3:
    [his_x, his_vx, his_ax, his_jx, his_y, his_vy, his_ay, his_jy,his_dpsi, his_time_cal_lc] = optim_weights(theta, init_matrix,des_matrix,dict_list, files,str(rec),plot_opti_weights,f_obs,axcom1a,axcom1b,axcom2,axcom3a,axcom3b,axcom4a,axcom4b,axcom5a,axcom5b,axcom6,axcom7a,axcom7b,axcom8a,axcom8b)
    [f1, f2, f3, f4, f5] = calc_features(his_x, his_vx, his_ax, his_jx, his_y, his_vy, his_ay, his_jy,his_dpsi,his_time_cal_lc, des_matrix)
    ...
    # Normalization
    f_calc_rel = plt.array([f1/f1_o, f2/f2_o, f3/f3_o, f4/f4_o, f5/f5_o])
    ...
    axf.plot([f_calc_rel[0], f_calc_rel[1], f_calc_rel[2], f_calc_rel[3], f_calc_rel[4]],
             '-', marker='o', markersize=6, label="Calc Features iter: " + str(rec))
    axf.legend()
    axfn.plot([f1, f2, f3, f4, f5],
             '-', marker='o', markersize=6, label="Calc Features iter: " + str(rec))
    axfn.legend()
    rec = rec + 1
    his_weights.append([str(rec) + "//", theta])
