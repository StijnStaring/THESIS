...
rec = 1
plot_datasets = 0
alpha = 0.2 # learing rate between 0 and 1
...
while rec < 9:
    [his_x, his_vx, his_ax, his_jx, his_y, his_vy, his_ay, his_jy, his_time_cal_lc] = optim_weights(theta, init_matrix,des_matrix,dict_list, files,str(rec),1)
