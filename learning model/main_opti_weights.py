...
# while rec <3 :
    print('rec is: ',rec)
    plotting_calc = 0
    [data_s, f_calc] = optim_weights_ideal(theta,width_road,vx_start,time_guess,rec,500,plotting_calc,axcom1a,axcom1b,axcom2,axcom3a,axcom3b,axcom4a,axcom4b,axcom5a,axcom5b,axcom6a,axcom6b,axcom7a,axcom7b,axcom8a,axcom8b)
