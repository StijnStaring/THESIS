def define_plots(theta_iter,x_sol,y_sol,vx_sol,vy_sol,ax_sol,ay_sol,jx_sol,jy_sol,psi_sol,psi_dot_sol,psi_ddot_sol,throttle_sol,delta_sol,throttle_dot_sol,delta_dot_sol,T_sol,aty_sol,any_sol,atx_sol,anx_sol,speed,width):
    """"
    ...
    plt.ylabel("Longitudinal distance [m]", fontsize=14)
    plt.grid(True)
    ...
    ax1b = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Lateral distance [m]", fontsize=14)
    ...
    ax4a = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Longitudinal acceleration [m/s^2]", fontsize=14)
    plt.grid(True)
    ...
    ax5a = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Longitudinal jerk [m/s³]", fontsize=14)
    plt.grid(True)
    ...
    ax5b = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Lateral jerk [m/s³]", fontsize=14)
    ...
    ax6a = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Yaw angle [°]", fontsize=14)
    plt.grid(True)
    ...
    ax6b = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Yaw angle/s [°/s]", fontsize=14)
    ...
    ax8a = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Ayt [m/s²]", fontsize=14)
    plt.grid(True)
    ...
    ax8b = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Ayn [m/s²]", fontsize=14)
    plt.grid(True)
    ...
    ax9 = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Yaw acceleration [°/s²]", fontsize=14)
    plt.grid(True)
    ...
    ax10a = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Axt [m/s²]", fontsize=14)
    plt.grid(True)
    ...
    ax10b = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("Axn [m/s²]", fontsize=14)
    plt.grid(True)
    plt.title('Axn', fontsize=14)
    plt.tight_layout()

    # Inputs
    plt.figure("inputs_dot: iter " + theta_iter, figsize=(10, 4))
    plt.subplot(1, 2, 1)
    ax11a = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("throttle_dot [1/s]", fontsize=14)
    plt.grid(True)
    plt.title('throttle_dot ', fontsize=14)
    plt.tight_layout()

    plt.subplot(1, 2, 2)
    ax11b = plt.gca()
    plt.xlabel("Time [s]", fontsize=14)
    plt.ylabel("delta_dot [°/s]", fontsize=14)
    plt.title('delta_dot ', fontsize=14)
    plt.grid(True)
    plt.tight_layout()
    ...
    ax10a.plot(time_vector, atx_sol, '.-', linewidth=3.0, label="SP: " + str(speed) + " W: " + str(width))
    ax10b.plot(time_vector, anx_sol, '.-', linewidth=3.0, label="SP: " + str(speed) + " W: " + str(width))
    ax11a.plot(time_vector[0:-1], throttle_dot_sol, '.-', linewidth=3.0, label= "SP: " +str(speed)+" W: " + str(width))
    ax11b.plot(time_vector[0:-1], delta_dot_sol*180/plt.pi, '.-', linewidth=3.0, label= "SP: " +str(speed)+" W: " + str(width))
